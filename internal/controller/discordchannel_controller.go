...
// +kubebuilder:rbac:groups=shopops.com,resources=discordchannels,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=shopops.com,resources=discordchannels/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=shopops.com,resources=discordchannels/finalizers,verbs=update
